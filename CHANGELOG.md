...
* [#xxxx](https://github.com/bbatsov/rubocop/pull/xxxx): `Style/RedundantParentheses` Don't flag negative numeric raised to a power literals, since removing the parentheses would change the meaning of the expressions. ([@amogil][])
